...
/**
 * FilePickerPlugin - v2 embedding only (no Registrar/v1)
 */
...
public class FilePickerPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    private static class MethodResultWrapper implements MethodChannel.Result {
        ...
        public void success(final Object result) {
            this.handler.post(() -> MethodResultWrapper.this.methodResult.success(result));
        }

        @Override
        public void error(final String errorCode, final String errorMessage, final Object errorDetails) {
            this.handler.post(() -> MethodResultWrapper.this.methodResult.error(errorCode, errorMessage, errorDetails));
        }

        @Override
        public void notImplemented() {
            this.handler.post(() -> MethodResultWrapper.this.methodResult.notImplemented());
        }
    }

    /**
     * Setup for v2 embedding only.
     */
    private void setup(final BinaryMessenger messenger, final Application application, final Activity activity, final ActivityPluginBinding activityBinding) {
        ...
        if (activityBinding != null) {
            ...
            if (activity.getApplicationContext() != null) {
                ((Application) activity.getApplicationContext()).registerActivityLifecycleCallbacks(this.observer);
            }
    ...
    private void tearDown() {
        if (this.activityBinding != null && this.delegate != null) {
        ...
        if (this.observer != null && this.lifecycle != null) {
            ...
            if (this.application != null && this.observer != null) {
                try {
